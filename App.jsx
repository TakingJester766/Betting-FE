...
import { Home, ExampleUI, Hints, Subgraph, Game, HostGame } from "./views";
  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route path="/game">
          <Game yourLocalBalance={yourLocalBalance} readContracts={readContracts} />
        </Route>
        <Route path="/HostGame">
          <HostGame yourLocalBalance={yourLocalBalance} readContracts={readContracts} />
        </Route>
      </Switch>
